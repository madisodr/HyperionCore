...
enum RBACPermissions
{
	...
	RBAC_PERM_COMMAND_JANUS_LINK = 1001,
	RBAC_PERM_COMMAND_JANUS_DELETE = 1002,
	RBAC_PERM_COMMAND_IDYIA = 1003,
	RBAC_PERM_COMMAND_ATHENA = 1004,
	RBAC_PERM_COMMAND_ATHENA_SELECT = 1005,
	RBAC_PERM_COMMAND_ATHENA_LINK = 1006,
	RBAC_PERM_COMMAND_ATHENA_UNLINK = 1007,
	RBAC_PERM_COMMAND_BARBERSHOP = 1008,
	RBAC_PERM_COMMAND_WARP = 1009,
	RBAC_PERM_COMMAND_ARES_ROLL = 1010,
	RBAC_PERM_COMMAND_ARES_VIEW = 1011,
  RBAC_PERM_COMMAND_FACE = 1012,
  RBAC_PERM_MAX
};
